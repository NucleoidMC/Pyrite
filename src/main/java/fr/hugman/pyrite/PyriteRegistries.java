...
public class PyriteRegistries {
	...
	public static final SimpleRegistry<PyriteTriggerType> TRIGGER_EVENT_TYPE = FabricRegistryBuilder.createSimple(PyriteTriggerType.class, Pyrite.id("trigger_type")).buildAndRegister();
}
