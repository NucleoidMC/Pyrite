 ...
 * <p>Inspired by the <a href="https://github.com/DawnTeamMC/DawnAPI/blob/d17116f9dce22efbfc022402c5bbbc9fc9e4222a/src/main/java/fr/hugman/dawn/registry/ReloadableResourceManager.java">Dawn API</a>.
 *
...
public class ReloadableResourceManager<R> {
	...
	private ReloadableResourceManager(Codec<R> codec, String folderPath) {
		this.codec = codec;
	 ...
	 * @param <R>        the resource
	 */
	public static <R> ReloadableResourceManager<R> of(@NotNull Codec<R> codec, @NotNull String folderPath) {
		Objects.requireNonNull(codec);
		Objects.requireNonNull(folderPath);
		if(folderPath.endsWith("/")) {
			throw new IllegalArgumentException("The folder path must not end with a slash.");
		}
		return new ReloadableResourceManager<>(codec, folderPath);
	}
	...
	/**
	 * Returns the key of the given startValue in the manager.
	 */
	public Identifier getId(R value) {
		...
		throw new IllegalArgumentException("The given startValue does not have a key.");
	}
